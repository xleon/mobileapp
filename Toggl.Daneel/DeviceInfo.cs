    ...
    public sealed class DeviceInfo : IDeviceInfo
    {
        ...
        private string getDeviceModel()
        {
            try
            {
                ...
                int sysctlResult;
                sysctlResult = sysctlbyname(hardwareProperty, IntPtr.Zero, pointerToLength, IntPtr.Zero, 0);
                if (sysctlResult != 0)
                {
                ...
                sysctlResult = sysctlbyname(hardwareProperty, pointerToDeviceString, pointerToLength, IntPtr.Zero, 0);
        ...
        private string toDeviceModel(string identifier)
        {
            switch (identifier) {
                case "iPod5,1":
                    return "iPod Touch 5";
