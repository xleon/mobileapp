...
{
    public class GetFeedbackInfoInteractor : IInteractor<IObservable<Dictionary<string, string>>>
    {
        ...
        public GetFeedbackInfoInteractor(
        ...
        public IObservable<Dictionary<string, string>> Execute()
            => Observable.Zip(
                workspacesCount,
                timeEntriesCount,
