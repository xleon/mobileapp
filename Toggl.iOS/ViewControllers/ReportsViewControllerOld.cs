...
{
    public sealed partial class ReportsViewControllerOld : ReactiveViewController<ReportsViewModelOld>, IScrollableToTop
    {
        ...
        public ReportsViewControllerOld(ReportsViewModelOld viewModel) : base(viewModel, nameof(ReportsViewControllerOld))
        {
        }
