...
namespace Toggl.Core.UI.ViewModels.Reports
{
    ...
    [Obsolete("Deprecated in favor of the new ReportsViewModel")]
    public sealed class ReportsViewModelOld : ViewModel
    {
        ...
        public ReportsViewModelOld(ITogglDataSource dataSource,
